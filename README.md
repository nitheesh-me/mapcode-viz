...
or use the [VSCode extension for Typst](https://marketplace.visualstudio.com/items?itemName=myriad-dreamin.tinymist) to compile/preview directly from the editor.
